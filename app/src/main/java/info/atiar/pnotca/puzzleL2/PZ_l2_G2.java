...
public class PZ_l2_G2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pz_l2__g2);


        target1 = (ImageView) findViewById(R.id.pz_l2_g2_11);
        target2 = (ImageView) findViewById(R.id.pz_l2_g2_12);
        target3 = (ImageView) findViewById(R.id.pz_l2_g2_13);
        target4 = (ImageView) findViewById(R.id.pz_l2_g2_21);
        target5 = (ImageView) findViewById(R.id.pz_l2_g2_22);
        target6 = (ImageView) findViewById(R.id.pz_l2_g2_23);
        target7 = (ImageView) findViewById(R.id.pz_l2_g2_31);
        target8 = (ImageView) findViewById(R.id.pz_l2_g2_32);
        target9 = (ImageView) findViewById(R.id.pz_l2_g2_33);

        source1 = (ImageView) findViewById(R.id.pz_l2_q_g2_11);
        source2 = (ImageView) findViewById(R.id.pz_l2_q_g2_12);
        source3 = (ImageView) findViewById(R.id.pz_l2_q_g2_13);
        source4 = (ImageView) findViewById(R.id.pz_l2_q_g2_21);
        source5 = (ImageView) findViewById(R.id.pz_l2_q_g2_22);
        source6 = (ImageView) findViewById(R.id.pz_l2_q_g2_23);
        source7 = (ImageView) findViewById(R.id.pz_l2_q_g2_31);
        source8 = (ImageView) findViewById(R.id.pz_l2_q_g2_32);
        source9 = (ImageView) findViewById(R.id.pz_l2_q_g2_33);
