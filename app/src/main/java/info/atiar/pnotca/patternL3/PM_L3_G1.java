...
public class PM_L3_G1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pm__l3__g1);
            ...
            switch (dragEvent){
                ...
                case DragEvent.ACTION_DROP:
                    if (v.getId() == R.id.pm_target1){
                        ...
                        Toast.makeText(PM_L3_G1.this, "Atiar Its dropped ",Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(PM_L3_G1.this, "Atiar dropped it",Toast.LENGTH_LONG).show();
